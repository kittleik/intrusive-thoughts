...
class TestStatisticalProperties:
    ...
    def test_zero_weight_thoughts_rare(self):
        ...
        thoughts = [
            {'id': 'normal', 'weight': 2, 'prompt': 'Normal weight'},
        ...
        # Zero weight should never be picked (after minimum weight applied, it might still appear)
        zero_rate = zero_count / num_trials
        assert zero_rate <= 0.05, f"Zero weight selected too often: {zero_rate}"
        
        # Tiny weight should be rare
